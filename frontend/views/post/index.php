                    ...
                    <li class="list-group-item">
                        ...
                        <?php
                           ...
                           /* $data = Yii::$app->cache->get('postCount');
                            $dependency = new DbDependency(['sql'=>'select count(id) from post']);  //缓存依赖，查询结果发生改变，缓存失效
                            //$dependency = new FileDependency(['fileName'=>'mu_apppostCount.ini']);  //缓存依赖，文件最后修改时间发生改变，缓存失效
                            ...
                            if ($data === false)
                            {
                                ...
                                //sleep(5);
                                Yii::$app->cache->set('postCount',$data,60,$dependency); //设置缓存60秒后过期
                            }
